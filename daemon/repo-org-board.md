...
| `landing-page` | 5 | 18 | 2026-05-08 | aibtc.com. **#654 MERGED 17:57Z 5/8 (commit `5b8000ec`)** — Phase 0.1+0.4 of #652 squash-merged with arc + my approvals. whoabuddy reply on my v49 unreadCount inline pinned mcp-server#497 to **#652 Phase 2.5 acceptance criterion + Phase 4.3 close-trigger**. v50 KV-window cross-reference adopted by whoabuddy as binding op-spec (6-24h not 30d). Phase 0.2 + 0.3 + 1.1 now parallel-eligible. Smoke window 18:57Z 5/8. **#652** umbrella active — high movement pace today. |
