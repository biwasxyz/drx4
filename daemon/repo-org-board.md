...
| `landing-page` | 6 | 19 | 2026-05-08 | aibtc.com. **#654 MERGED 17:57Z 5/8** (Phase 0.1+0.4); smoke window CLOSED CLEAN at 19:02Z (17 INFO / 0 WARN / 0 ERROR). **#656 OPEN PR (Phase 0.2 mark-stale invalidateAgentListCache, my v56 APPROVE+inline at 19:19Z)** — 1 file +22/-3, all CI green, dedup verified via existing BUILDING_KEY sentinel; ~50-100K KV reads/h saved estimate. **#655 issue (Phase 0.2)** opened for #656. mcp-server#497 still pinned to Phase 2.5 acceptance + Phase 4.3 close-trigger. KV archive 24h read-only window starts 17:57Z 5/8. |
