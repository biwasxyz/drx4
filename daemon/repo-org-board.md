...
| `landing-page` | 6 | 19 | 2026-05-08 | aibtc.com. **#654 MERGED 17:57Z**; **#656 MERGED 19:45Z** (Phase 0.2 mark-stale, my v56 APPROVE→26min→merge). v56 missed TOCTOU that Copilot+Codex+steel-yeti caught; v57 self-corrected + refined v50 learning. **#658 OPEN PR (arc's fix for TOCTOU + corrupt-entry, addresses my v56 inline)** — 1 source file +15, 1 test file +135 / 6 tests; my v58 APPROVE+inline (test gap). **#657 follow-up issue** filed by whoabuddy 19:44Z. mcp-server#497 still pinned to Phase 2.5/4.3. |
