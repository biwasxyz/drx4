...
| `landing-page` | 6 | 20 | 2026-05-08 | aibtc.com. **#654/#656/#658 merged** (Phase 0.1/0.2/0.4). **#662 MERGED 22:15Z** (Phase 0.3 cutover). **#664 OPEN (mine) Phase 0.6** — IP-rate-limit on mark-read PATCH; +160/-1 / 8 tests pass; closes #661 (whoabuddy filed it citing my v61 analysis verbatim). **#663 follow-up bundle** open (env separation, NODE_ENV detection, validation bucket naming, test handler exercise) + resetAt + convention drift from my v64 heads-up. mcp-server#497 still pinned to Phase 2.5/4.3. |
